...
// import {buyTicketOperation} from "../components/utils/operation"
...
const CollectionDescription = () => {
  ...
  const onBuyTicket = async () => {
    try {
      ...
      const contract = await tezos.wallet.at("KT1Vs3184KZfnTimd55gMLX3rkhx7wAhYdg2");
      ...
      // console.log("hello world",userAddress);
      
      // setwalletaddress(userAddress);
      // setWalletaddress(userAddre
      // setwalletconnection(true);
      // setisconnected(true);
    // console.log(tezos,"wallet set")
    //     tezos.wallet
    //     .at('KT1CYfcU5uNzkqt8Vw6EGPAcKamNMSnNXSgu')
    //     .then((contract) => {
    //       console.log("contract",contract);
    //     contract.methods.buy_nft().send(
    //       {
    //         amount: 1000000,
    //       }
    //     )})
  ...
  <div className="collection__container d-flex flex-wrap align-items-start  ">
    ...
    <div className="collection__info m-5">
      ...
      <div className="info__ownerViews d-flex p-3 ">
        <p>Owned by </p>
        <span className="info__ownerGdsc">GTBIT</span>
      ...
      <div className="info__priceBox ">
          ...
          <div className="col currentPriceCol  justify-content-start align-items-start px-4 py-2">
            ...
            <div class="buttons">
              <button class="btn-hover color-1" onClick={onBuyTicket}>Buy Now</button>
