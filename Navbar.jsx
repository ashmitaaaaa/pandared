...
import tiger_icon from "../assets/images/nft4.jpg";
// import GDSC_icon from "../assets/images/GDSC_icon.png";
// import Logo from "../assets/images/logo.jpeg"
import Logo from "../assets/images/iconnn.png"
function Navbar() {
  return (
    <div>
      <nav className="navbarHomeContainer">
        <div className="navbarHomeContainer1">
          ...
          <div>
            <img className="navbarGDSCIcon" src={Logo} alt="GDSC LOGO" />
          </div>
        </div>
      </nav>
